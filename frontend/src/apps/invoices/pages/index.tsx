...
import { type InvoiceEvent } from "@/apps/notifications/events";
import { getToken } from "@/apps/auth/utils/token";
import { useActiveEnv } from "@/apps/settings/utils/active-env";
import { usePreferences } from "@/apps/settings/utils/preferences";
...
import { trackSubmitBatch } from "@/apps/invoices/utils/batch-tracker";
import { invoicesStore, useInvoicesDispatch, useInvoicesSelector } from "../store/invoices.store";
import { invoicesActions } from "../store/invoices.slice";
import { fetchInvoices } from "../store/invoices.thunks";
import { invoiceSel } from "../store/invoices.selectors";
import { Card, Empty, Field, PageHeader, StatusDot } from "@/app/core/components/ui";
...
function InvoicesView() {
  ...
  const items = useInvoicesSelector(invoiceSel.selectAll);
  const invMeta = useInvoicesSelector((s) => s.invoices);
