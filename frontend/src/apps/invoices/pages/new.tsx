...
import { customersApi } from "@/apps/customers/services/customers.api";
import type { Customer } from "@/apps/customers/types/customer.types";
import { productsApi } from "@/apps/products/services/products.api";
import type { Product } from "@/apps/products/types/product.types";
import { currenciesApi } from "@/apps/currencies/services/currencies.api";
import type { TenantCurrency } from "@/apps/currencies/types/currency.types";
...
import { businessApi } from "@/apps/business/services/business.api";
import type { BusinessSettings } from "@/apps/business/types/business.types";
import { settingsApi } from "@/apps/settings/services/settings.api";
import { getToken } from "@/apps/auth/utils/token";
import { useMe } from "@/apps/auth/store/session";
import { useActiveEnv } from "@/apps/settings/utils/active-env";
import { EnvBadge } from "@/app/core/components/EnvSwitcher";
import { Banner, Card, Field, FieldGrid, PageHeader, Select, Tabs } from "@/app/core/components/ui";
import { DatePicker } from "@/app/core/components/DatePicker";
import { SearchSelect } from "@/app/core/components/SearchSelect";
import { pushNotification, suppressQueuedEcho } from "@/apps/notifications/notifications";
import { PAYMENT_METHODS, VAT_BY_CODE, VAT_CATEGORIES } from "@/app/core/constants/catalog";
