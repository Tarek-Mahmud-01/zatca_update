...
import { invoicesApi } from "@/apps/invoices/services/invoices.api";
import { type InvoiceEvent } from "@/apps/notifications/events";
import { getToken } from "@/apps/auth/utils/token";
import { useInvoiceEvents } from "@/apps/invoices/hooks/use-invoice-events";
import { Card, PageHeader, StatusDot } from "@/app/core/components/ui";
